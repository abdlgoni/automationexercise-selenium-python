...
class DriverFactory:
    ...
    def _get_chrome_driver():
        ...
        if Config.HEADLESS:
            options.add_argument("--headless=new")  # pakai versi baru headless
        ...
        options.add_argument("--disable-background-networking")  # kurangi background request
        ...
        options.add_experimental_option("prefs", {
            ...
            "profile.default_content_setting_values.sound": 2,        # mute autoplay
            "profile.managed_default_content_settings.images": 1,     # tetap load images
        })
